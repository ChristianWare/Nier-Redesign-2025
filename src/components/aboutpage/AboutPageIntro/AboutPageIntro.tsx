        ...
        <div className={styles.content}>
          ...
          <div className={styles.textContainer}>
            <p className={styles.text}>
              At Nier Transportation, we&lsquo;re more than a car service; we&lsquo;re your
              trusted partner in high end transportation. With a passion for
              providing the best car service in the Phoenix Metro area, we&lsquo;ve
              been serving the Arizona community for 20 years. Our mission is
              clear: to provide an unparalleled, high end, late model car
